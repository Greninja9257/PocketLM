...
Same prompts, four sizes. This is the whole story in one table:

| you | `1k` · 984p | `10k` · 9.5Kp | `50k` · 48Kp | `500k` · 491Kp |
|---|---|---|---|---|
| hey | i abor tot what. | hey there — PocketLM. | hey there — PocketLM. | hey! I'm PocketLM. |
| what's your name? | id? | pleepve stion. | PocketLM. | I'm PocketLM, hello! |
| I'm having a rough day | ro's poing you. | that's a bad one. do you want to talk about it? | that's a bad one. do you want to talk about it? | ah, that sucks. want to tell me what happened? |
| tell me a joke | you or — gontoing? | why did the scare — asble, teuickroying. | why did the scarecrow win an award? | what do you call cheese that isn't yours? |
| what's the capital of Chad? | here poteth what'm. | nope, no clue. you rather PocketLM ould thsame. | that's outside what I know. | not something I know. |
| I went to the beach | you abouro! | any good? how'd that go? | nice — how was it? you? | oh? how'd it go? tell me more? |
| bye | gket po— abe ke? | nice. doing anything fun today? | see you! | night! sleep well. |

984 parameters buys English-*shaped* noise — word fragments, apostrophes in
plausible places, question marks ending questions. Around 10K the replies
become real sentences that are sometimes the wrong ones. By 500K it holds a
conversation and declines what it doesn't know.
